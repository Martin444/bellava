            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  child: Column(
                    children: <Widget>[
                      _buildExpancion("Introduje mal un dato en la orden de mi pedido", 
                        "Comunícate con Soporte para que podamos revertir la situación lo más pronto."),
                      _buildExpancion("Debo cancelar o modificar el horario/día de mi orden", 
                      ...
                      _buildExpancion("Mi servicio solicitado se duplico varias veces.", 
                      ...
                      _buildExpancion("Mi solicitud de servicio no fue aceptada.", 
                      ...
                      _buildExpancion("Mi profesional me quiere hacer un recargo extra por un servicio", 
                      ...
                      _buildExpancion("Tuve un problema o algo no salió bien con mi profesional.", 
                        "Comunícate lo antes posible con Soporte para poder asistirte."),
                      _buildExpancion("Mi profesional desea contactarme para realizar un servicio futuro por vías ajenas a la aplicación.",
