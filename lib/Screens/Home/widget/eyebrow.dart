...
class _EyebrowState extends State<Eyebrow> {
  ...
  Widget build(BuildContext context) {
    int Total =
        pTotal1 + pTotal2 + pTotal3 + pTotal4 + pTotal5 + pTotal6 + pTotal7;
                  ...
                  child: Container(
                    child: ListView(
                      children: <Widget>[
                        ...
                        // Cejas
                        CardCategory("Perfilado.", "${price1}", count1, () {
                          if (count1 >= 0) {
                            setState(() {
                              count1 = count1 + 1;
                        ...
                        CardCategory("Perfilado con Henna", "${price2}", count2,
                            () {
                          if (count2 >= 0) {
                            setState(() {
                              count2 = count2 + 1;
                        ...
                        CardCategory("Tinte cejas", "${price3}", count3, () {
                          if (count3 >= 0) {
                            setState(() {
                              count3 = count3 + 1;
                        ...
                        CardCategory(
                            "Sombreado efecto polvo", "${price4}", count4, () {
                          if (count4 >= 0) {
                            setState(() {
                              count4 = count4 + 1;
                        ...
                        CardCategory("Microblading", "${price5}", count5, () {
                          if (count5 >= 0) {
                            setState(() {
                              count5 = count5 + 1;
                        ...
                        CardCategory("Microshading", "${price6}", count6, () {
                          if (count6 >= 0) {
                            setState(() {
                              count6 = count6 + 1;
                        ...
                        Container(
                          ...
                          child: CardCategory(
                              "Retoque Microblading/Microshading",
                              "${price7}",
                              count7, () {
                            if (count7 >= 0) {
                              setState(() {
